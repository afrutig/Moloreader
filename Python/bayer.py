...
'''
Capture the red channel of raw bayer data.
'''
def captureRawRed(shutter_speed, iso=100):
	stream = io.BytesIO()
...
if __name__ == '__main__':
	...
	red_bayer = captureRawRed(shutter_speed=50000)
	print('shape: ', red_bayer.shape)
	imshow(red_bayer)
	show()
